...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static void IsElementPresentOrNot(this IWebDriver webDriver, ElementLocator locator, string name, string SearchText)
        {
            try
            {
                ...
                DriverContext.ExtentStepTest.Log(LogStatus.Pass, name + " : element is found successfully");
            }
            catch (Exception ex)
            {
                Logger.Info(name + " : element not found , Text Found :" + SearchText + ex.ToString());
                DriverContext.ExtentStepTest.Log(LogStatus.Pass, name + " : element not found");
            }
        }
        /// <summary>
        ...
        public static void AreElementsSortedInAlphabeticalOrder(this IWebDriver webDriver, ElementLocator locator, string link)
        {
            try
            {
                WaitForPageLoad(webDriver);
