...
namespace MCS.Test.Automation.Common.Extensions
{
    ...
    public static class SearchContextExtensions
    {
        ...
        /// <summary>
        /// Finds and waits for an element that is disabled and displayed for long timeout.
        /// </summary>
        /// <param name="element">The element.</param>
        /// <param name="locator">The locator.</param>
        /// <param name="customMessage">Custom message to be displayed when there is no possible to get element</param>
        ...
        /// this.Driver.GetElement(this.loginButton);
        /// </code></example>
        public static IWebElement GetElementForDisabled(this ISearchContext element, ElementLocator locator, [Optional] string customMessage)
        {
            return element.GetElement(locator, BaseConfiguration.LongTimeout, e => e.Displayed || !(e.Enabled), customMessage);
        }
