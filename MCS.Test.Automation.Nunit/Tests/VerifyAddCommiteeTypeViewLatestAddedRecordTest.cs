// <copyright file="VerifyAddCommiteeTypeViewLatestAddedRecordTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Nunit.Tests
{
    ...
    [TestFixture]
    public class VerifyAddCommiteeTypeViewLatestAddedRecordTest : ProjectTestBase
    {
        [Test]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-1981", Name = "Rules and Exceptions - Add new Committee Type - View latest added record")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "ManageCommitteeTypes1" })]
        public void VerifyAddCommiteeTypeViewLatestAddedRecord(Dictionary<string, string> parameters)
        {
            ...
            manageCommiteeTypePage.IsGetLatestRecordDisplayed(committeeTypeNameText);
        }
    }
}
