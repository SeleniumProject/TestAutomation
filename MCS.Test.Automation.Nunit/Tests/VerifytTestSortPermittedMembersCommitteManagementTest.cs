// <copyright file="VerifytTestSortPermittedMembersCommitteManagementTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Nunit.Tests
{
    ...
    [TestFixture]
    public class VerifytTestSortPermittedMembersCommitteManagementTest : ProjectTestBase
    {
        [Test]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2012", Name = "Rules and Exceptions - Manage Committee Type - Sort Committee Type List based on Permitted Members")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "ManageCommitteeTypes" })]
        public void VerifytTestSortPermittedMembersCommitteManagement(Dictionary<string, string> parameters)
        {
            ...
            manageCommiteeTypePage.IsPermittedMembersUserAbleToClickOnSortIcon();
            manageCommiteeTypePage.IsPermittedMembersIConSortedSuccessfully();
            manageCommiteeTypePage.AreListOfPermittedMembersElementsDisplayInAlphabeticalOrderOrNot();
        }
    }
}
