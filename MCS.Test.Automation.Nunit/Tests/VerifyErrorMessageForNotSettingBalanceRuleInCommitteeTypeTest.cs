// <copyright file="VerifyErrorMessageForNotSettingBalanceRuleInCommitteeTypeTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Nunit.Tests
{
    ...
    [TestFixture]
    public class VerifyErrorMessageForNotSettingBalanceRuleInCommitteeTypeTest : ProjectTestBase
    {
        [Test]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2227", Name = "Rules and Exceptions  - Manage Committee Type - Error message for not setting Balance Rule")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "ErrorMessageForNotSettingBalanceRule" })]
        public void VerifyErrorMessageForNotSettingBalanceRuleInCommitteeType(Dictionary<string, string> parameters)
        {
