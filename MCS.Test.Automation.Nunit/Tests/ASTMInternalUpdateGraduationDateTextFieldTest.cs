// <copyright file="ASTMInternalUpdateGraduationDateTextFieldTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Tests.NUnit.Tests
{
    ...
    [TestFixture]
    public class ASTMInternalUpdateGraduationDateTextFieldTest : ProjectTestBase
    {
        [Test]
        [Category("ASTM_Internal")]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2744", Name = "ASTM General Information Section-Update 'Graduation Date' text field")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "UpdateGraduationDateTextField" })]
        public void ASTMInternalUpdateGraduationDateTextField(Dictionary<string, string> parameters)
        {
