// <copyright file="ASTMInternalUpdateButtonTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Tests.NUnit.Tests
{
    ...
    [TestFixture]
    public class ASTMInternalUpdateButtonTest : ProjectTestBase
    {
        [Test]
        [Category("ASTM_Internal")]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2754", Name = "ASTM General Information Section-Update Button")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "ASTMGeneralInformationUpdate" })]
        public void ASTMInternalUpdateButton(Dictionary<string, string> parameters)
        {
