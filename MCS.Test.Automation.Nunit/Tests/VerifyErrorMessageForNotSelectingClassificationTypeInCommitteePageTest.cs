// <copyright file="VerifyErrorMessageForNotSelectingClassificationTypeInCommitteePageTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Nunit.Tests
{
    ...
    [TestFixture]
    public class VerifyErrorMessageForNotSelectingClassificationTypeInCommitteePageTest : ProjectTestBase
    {
        [Test]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2228", Name = "Rules and Exceptions  - Set Balance Rule - Error message for not selecting Classification Type")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "ErrorMessageForClassficationType" })]
        public void VerifyErrorMessageForNotSelectingClassificationTypeInCommitteePage(Dictionary<string, string> parameters)
        {
