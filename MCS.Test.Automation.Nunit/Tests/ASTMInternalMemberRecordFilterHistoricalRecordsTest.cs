// <copyright file="ASTMInternalMemberRecordFilterHistoricalRecordsTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Tests.NUnit.Tests
{
    ...
    [TestFixture]
    public class ASTMInternalMemberRecordFilterHistoricalRecordsTest : ProjectTestBase
    {
        [Test]
        [Category("ASTM_Internal")]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2124", Name = "ASTM staff internal application - Member List Page - Filtering of Members Records based on Status - Historical member records")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "ASTMInternalMemberRecordFilterHistoricalRecords" })]
        public void ASTMInternalMemberRecordFilterHistoricalRecords(Dictionary<string, string> parameters)
        {
