// <copyright file="VerifyRemoveParentLevelCommitteManagementTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Nunit.Tests
{
    ...
    [TestFixture]
    public class VerifyRemoveParentLevelCommitteManagementTest : ProjectTestBase
    {
        [Test]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2029", Name = "Rules and Exceptions - Removing Level for a Committee Type - Remove a parent level")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "ManageCommitteeTypes" })]
        public void VerifyRemoveParentLevelCommitteManagement(Dictionary<string, string> parameters)
        {
