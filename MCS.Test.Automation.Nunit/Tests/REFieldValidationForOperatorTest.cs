// <copyright file="REFieldValidationForOperatorTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Nunit.Tests
{
    ...
    [TestFixture]
    public class REFieldValidationForOperatorTest : ProjectTestBase
    {
        [Test]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2234", Name = "Rules and Exceptions  - Set Balance Rule - Field Validation - Operator")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "FieldValidationOperator" })]
