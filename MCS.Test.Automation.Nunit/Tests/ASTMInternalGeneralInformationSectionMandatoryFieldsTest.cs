// <copyright file="ASTMInternalGeneralInformationSectionMandatoryFieldsTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Tests.NUnit.Tests
{
    ...
    [TestFixture]
    public class ASTMInternalGeneralInformationSectionMandatoryFieldsTest : ProjectTestBase
    {
        [Test]
        [Category("ASTM_Internal")]
        [Category("Regression")]
        [TestCaseDescription(Id = "MCS2-2755", Name = "ASTM General Information Section-Mandatory fields")]
        [TestCaseSource(typeof(TestData), "GetDetailsFromXML", new object[] { "MemberManagementGeneralInfoMandatoryFields" })]
        public void ASTMInternalGeneralInformationSectionMandatoryFields(Dictionary<string, string> parameters)
        {
            ...
            string graduationDateErrorMsg = parameters["graduationDateErrorMsg"].Trim();
            membershipManagementPage.IsGetErrorMessageForGraduationField(graduationDateErrorMsg);
            string reasonForUpdateErrorMsg = parameters["ReasonForUpdateErrorMsg"].Trim();
            membershipManagementPage.IsGetErrorMessageForReasonForUpdateField(reasonForUpdateErrorMsg);
        }
    }
}
